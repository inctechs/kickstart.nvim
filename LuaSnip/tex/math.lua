...
return {
  s({ trig = 'frac', dscr = 'LaTex math fraction' }, fmta('\\frac{<>}{<>}', { i(1, 'numerator'), i(2, 'denominator') }), { condition = tsutils.in_mathzone }),
  s('prod', fmta('\\prod_{<>}{<>}', { i(1), i(2) }), { condition = tsutils.in_mathzone }),
  s('int', fmta('\\int_{<>}{<>}', { i(1, '-\\infty'), i(2, '\\infty') }), { condition = tsutils.in_mathzone }),
  ...
  s({ trig = 'eu', dscr = "Euler's number" }, fmta('e^{<>}', { i(1) }), { condition = tsutils.in_mathzone }),
  s(
  ...
  s({ trig = 'lr|', name = 'left right', dsc = 'Left right with bars' }, fmta('\\left\\| <> \\right\\|', { i(1) }), { condition = tsutils.in_mathzone }),
  s({ trig = 'lr<', name = 'leftangle rightangle', dsc = 'Left and right angle' }, fmt('\\left< {} \\right>', { i(1) }), { condition = tsutils.in_mathzone }),
  s({ trig = 'dv', name = 'Derivative' }, fmta('\\dv[<>]{<>}{<>}', { i(1), i(2), i(3) }), { condition = tsutils.in_mathzone }),
  s({ trig = 'pdv', name = 'Partial Derivative' }, fmta('\\pdv[<>]{<>}{<>}', { i(1), i(2), i(3) }), { condition = tsutils.in_mathzone }),
  autosnippet(
    {
      trig = '(%a)(%d)',
      regTrig = true,
  ...
  s({ trig = '<->', name = 'Left-right arrow' }, t '\\leftrightarrow', { condition = tsutils.in_mathzone }),
  autosnippet({ trig = 'inf', name = 'Infinity' }, t '\\infty', { condition = tsutils.in_mathzone }),
}
